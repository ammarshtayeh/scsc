...
export function Card({ className, interactive, ...props }: CardProps) {
  return (
    <div
      className={cn(
        "glass-surface showcase-panel rounded-[24px] border border-white/70 p-5 shadow-card backdrop-blur-xl ring-1 ring-brand-primary/5 dark:border-white/10 dark:shadow-[0_18px_46px_rgba(3,8,18,0.42)] dark:ring-white/8 sm:rounded-[28px] sm:p-6",
        interactive &&
